                                ...
                                <div className="card">
                                    <div className="card-body">
                                        ...
                                        <div className="mb-4 mt-3">
                                            <div id="world-map-markers" style={{height:224 + 'px'}}></div>
                                        </div>
                        ...
                        <div className="row">
                                ...
                                <div className="card">
                                    <div className="card-body">
                                        <div className="d-flex justify-content-between align-items-center mb-2">
                                            ...
                                            <a href="javascript:void(0);" className="btn btn-sm btn-link">Export <i className="mdi mdi-download ms-1"></i></a>
                                        </div>
                            ...
                            <div className="col-xl-3 col-lg-6 order-lg-1">
                                <div className="card">
                                    <div className="card-body">
                                        ...
                                        <div id="average-sales" className="apex-charts mb-4 mt-3"
                            ...
                            <div className="col-xl-3 col-lg-6 order-lg-1">
                                <div className="card">
                                    ...
                                    <div className="card-body py-0 mb-3" data-simplebar style={{ maxHeight: 403 + "px" }}> 
