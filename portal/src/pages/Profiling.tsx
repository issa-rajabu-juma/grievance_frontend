...
import ProfilingForm from '../features/griever/components/ProfilingForm'


const Profiling = (props: any) => {
      ...
      <div className="container">
        ...
        <div className="row justify-content-between">
          ...
          <div className="col-12 col-md-8">
            <ProfilingForm data={{grievers: props.grievers, user: props.user}} />
          </div>
        </div>
      </div>
    </section>
...
export default connect(mapStateToProps, null) (Profiling)