                    ...
                    <form style={{paddingTop:0.5 + 'em', width:100 + "%", marginLeft: 0 + '%'}} key={griever.griever_id}>
                            <div className="row">
                                ...
                                <div className="col-12 col-md-6">
                                    <div className="form-group">
                                        ...
                                        <input className="form-control form-control-sm form-control-underline" id="email" type="email" placeholder="email@uvw.xyz" name='email'  />
                                    </div>
                                </div>  
                                <div className="col-12 col-md-6">
                                    <div className="form-group">
                            ...
                            <div className="row mt-3">
                                <div className="col-12 col-md-12">
                                    <button className="btn btn-lg w-100 btn-link" type='submit' onClick={onUpdate}>
                                    UPDATE
                                    </button>
                                </div>
                            </div>
